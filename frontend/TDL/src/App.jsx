          ...
          <button className="landingButton"onClick={() => handleRegisterClick('Landing')}>
            <svg xmlns="http://www.w3.org/2000/svg" width="127" height="32" fill="none" viewBox="0 0 127 32">
              <g clip-path="url(#todoist-extended-logo_svg__a)">
                <path fill="#E44232" fill-rule="evenodd"
                ...
                <path fill="#fff"
                      d="m6.749 14.993 6.36-3.668.008-.005c3.192-1.84 6.412-3.698 6.553-3.78.277-.16.29-.65-.019-.828l-.217-.124c-.316-.18-.725-.414-.9-.516a1.016 1.016 0 0 0-.995.012c-.154.089-10.478 6.038-10.823 6.235a1.343 1.343 0 0 1-1.336 0L-.072 9.143v2.698l.056.033c1.361.795 4.582 2.674 5.37 3.12.478.27.935.264 1.395-.002Z"></path>
                <path fill="#fff"
                      d="m6.749 20.385 6.352-3.664.024-.014 6.545-3.775c.277-.16.29-.651-.019-.828l-.217-.124c-.316-.18-.725-.414-.9-.517a1.016 1.016 0 0 0-.995.012c-.154.09-10.478 6.039-10.823 6.235a1.343 1.343 0 0 1-1.336 0l-5.452-3.175v2.699l.057.033c1.362.795 4.581 2.674 5.37 3.12.477.27.934.264 1.394-.002Z"></path>
                <path fill="#fff"
                      d="m13.11 22.108-6.361 3.669c-.46.265-.917.272-1.394.002a944.524 944.524 0 0 1-5.37-3.12l-.057-.033v-2.699l5.452 3.175c.412.239.923.235 1.336 0 .345-.196 10.669-6.146 10.823-6.235.372-.214.773-.142.995-.012.175.103.584.336.9.517l.217.123c.31.178.296.669.02.829l-6.561 3.784Z"></path>
                <path fill="#E44232" fill-rule="evenodd"
